...
class StockSummaryService():
    ...
    def get_stock_summary(
        ...
        """
        Get stock summary data with various filtering options
        ...
        Returns:
            List of stock summary records as Pydantic models
        """
        try:
            with CassandraClient(self.cassandra_config) as cassandra_client:
                ...
                if not result or not result.get("records"):
                    logger.info(f"No stock summary data found for params: {filter_params}")
                    return []
